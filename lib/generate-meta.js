...
var stream = fs.createWriteStream("./lib/metadata.json");
...
// Why generate meta every time?
// Cache the result and assume this script will be run on subsequent metadata updates.
stream.write(JSON.stringify(tests, null, 2));
